...
RSpec.describe 'Session', type: :request do
  ...
  describe 'POST #create' do
    ...
    context 'when success' do
      ...
      before { post api_v1_session_index_path, params: params, headers: headers, as: :json }
    ...
    context 'when failed' do
      ...
      before { post api_v1_session_index_path, params: params }
  ...
  describe 'DELETE #destroy' do
    ...
    before { delete api_v1_session_path(user), headers: headers, as: :json }
